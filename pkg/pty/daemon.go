...
type DaemonConfig struct {
	...
	BufferSize  int    // ring buffer size in bytes (default: 32MB)
...
func RunDaemon(cfg DaemonConfig) error {
	...
	if cfg.BufferSize <= 0 {
		cfg.BufferSize = 32 << 20 // 32 MB, matches web MAX_REPLAY_BUFFER_BYTES; comfortably covers 50k-line scrollback pref
	}
