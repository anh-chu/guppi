...
// SVG path data from Simple Icons (simpleicons.org)
const agentIconPaths: Record<string, string> = {
  ...
  // OpenCode (from github.com/sst/opencode packages/ui/src/assets/icons/provider/opencode.svg)
  opencode:
...
// Text fallbacks for agents without brand icons
