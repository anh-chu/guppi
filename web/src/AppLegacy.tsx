...
// AppLegacy is the pre-cutover UI. It is no longer reachable from any
// production entrypoint (see App.tsx) -- kept only until Task 4 deletes it
// and its supporting legacy hooks/routes outright.
